def send_email(massage, recipient, sender = "university.help@gmail.com"):
    if "@" not in sender or "@" not in recipient\
        ...
        or not (recipient.endswith('.com') or recipient.endswith('.ru') or sender.endswith('.net')):
...
send_email('Доброго дня!', 'vasyok1337gmail')
send_email('Доброго дня!', 'vasyok1337@gmail')